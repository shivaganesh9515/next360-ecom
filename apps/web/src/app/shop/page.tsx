...
export default function ShopPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-20">
      {/* Page Header */}
      <div className="bg-cream/40 border-b border-cream/50 py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <nav className="flex items-center justify-center gap-2 mb-4 text-sm font-medium text-slate-400">
