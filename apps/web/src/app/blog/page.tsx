                  ...
                  <Link href={`/blog/${featuredPost.slug}`} className="group block bg-white rounded-3xl overflow-hidden border border-slate-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-500">
                    <div className="relative aspect-[21/9] md:aspect-[3/1] overflow-hidden bg-slate-100">
                      ...
                      <div className="absolute top-6 left-6">
                        <Badge variant="fresh" className="bg-white/95 backdrop-blur-sm border-none shadow-lg text-primary font-bold px-4 py-1.5 uppercase tracking-widest textxs">
...
export default function BlogPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-gray-50 pt-20 flex items-center justify-center"><div className="w-8 h-8 rounded-full border-4 border-primary border-t-transparent animate-spin"></div></div>}>
      <BlogContent />
    </Suspense>
  )
}
